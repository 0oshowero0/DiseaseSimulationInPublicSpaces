...
def file_path():
    ...
    data_path['pop_distribution'] = './data/population_dist/WiFi_population.csv'

    data_path['departure_data'] = './data/aux_data/departure_info.csv'
    data_path['flight_data'] = './data/aux_data/flights_info.csv'
    data_path['security_ck_data'] = './data/aux_data/security_ck_info.csv'
    data_path['gates'] = './data/aux_data/gates_info.csv'

    data_path['map_npy'] = './data/maps/airport_map.npy'
    data_path['map_outlines'] = './data/maps/airport_map_255_processed.json'

    data_path['label_checkin'] = './data/labels/checkin.json'
    data_path['label_departure'] = './data/labels/departure.json'
    data_path['label_rest'] = './data/labels/rest.json'
    data_path['label_seat'] = './data/labels/seat.json'
    data_path['label_security_ck'] = './data/labels/security_ck.json'
    data_path['label_shop'] = './data/labels/shop.json'
...
def process_socialForce_traces_for_GAN(social_force_traces_loc='state0-24.json'):
    ...
    with open('./data/GAN/traces','w') as f:
        all_points = []
        for k,v in tqdm(social_force.items()):
            indiv = eval(v)
